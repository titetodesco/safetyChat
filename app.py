...
with st.sidebar:
    ...
    top_ws = st.slider("Top-N WS", 1, 200, 10, 1, key="sb_top_ws")
    top_prec = st.slider("Top-N Precursores", 1, 200, 10, 1, key="sb_top_prec")
    top_cp = st.slider("Top-N CP", 1, 50, 200, 1, key="sb_top_cp")
